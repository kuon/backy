defmodule BackyTest do
  ...
  defmodule TestWorker do
    ...
    def perform(%Backy.Job{}, %{width: width, height: height}) do
      send(
        :backy_test,
        {:job_has_been_run, width_was: width, height_was: height}
      )
    end
    ...
    def perform(%Backy.Job{}, [arg1, arg2, arg3]) do
      send(
        :backy_test,
        {:job_has_been_run, arg1_was: arg1, arg2_was: arg2, arg3_was: arg3}
      )
    end
  end
  ...
  test "store and execute jobs" do
    ...
    assert_receive {:job_has_been_run,
                    arg1_was: "foo", arg2_was: "atom_arg", arg3_was: "bar"}
